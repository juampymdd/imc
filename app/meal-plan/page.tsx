...
export default function MealPlanPage() {
  ...
  const getTotals = () => {
    ...
    return {
      ...
      protein:
        meals.breakfast.macros.protein +
        meals.lunch.macros.protein +
        meals.snack.macros.protein +
        meals.dinner.macros.protein,
      carbs:
        meals.breakfast.macros.carbs +
        meals.lunch.macros.carbs +
        meals.snack.macros.carbs +
        meals.dinner.macros.carbs,
      fat:
        meals.breakfast.macros.fat +
        meals.lunch.macros.fat +
        meals.snack.macros.fat +
      ...
      <div className="mx-auto w-full max-w-6xl space-y-6 p-4 pb-12">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white/50 p-4 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/50">
          <p className="flex items-start gap-2 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <span>
              <strong>Tip:</strong> Hacé clic en el ícono de recarga de cada
              comida para cambiarla individualmente, o generá un plan
              completamente nuevo con el botón de arriba.
            </span>
          </p>
        </div>
      </div>
